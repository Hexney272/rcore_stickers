...
CreateThread(function()
    if Config.Database and string.len(Config.Database) ~= 0 then
        if string.strtrim(string.lower(Config.Database)) == 'mysql-async' then
        ...
        elseif string.strtrim(string.lower(Config.Database)) == 'oxmysql' then
            DB.fetchAll = function(query, params)
        ...
        elseif string.strtrim(string.lower(Config.Database)) == 'ghmattimysql' then
            DB.fetchAll = function(query, params)
